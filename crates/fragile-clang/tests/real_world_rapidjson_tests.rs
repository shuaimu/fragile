...
#[test]
fn test_todo_keeps_phase2_duplicate_emission_parent_task_closed() {
    let todo =
        read_todo_file().expect("failed to read TODO.md for phase2 duplicate-emission closure");
    assert!(
...
#[test]
fn test_todo_keeps_phase2_array_decay_parent_task_closed() {
    let todo = read_todo_file().expect("failed to read TODO.md for phase2 array-decay closure");
    assert!(
