...
impl AstCodeGen {
    ...
    fn generate_comparison_category_stubs(&mut self) {
        ...
        // These are needed because we skip vtable generation for these types,
        // but constructor code still references the vtable constants
        self.writeln("// Stub vtable constants for locale types");
        self.writeln("unsafe fn __collate_char_stub_do_compare(_: *const collate_char_, _: *const i8, _: *const i8, _: *const i8, _: *const i8) -> i32 { 0 }");
        self.writeln("unsafe fn __collate_char_stub_do_transform(_: *const collate_char_, _: *const i8, _: *const i8) -> std::ffi::c_void { std::mem::zeroed() }");
        self.writeln("unsafe fn __collate_char_stub_do_hash(_: *const collate_char_, _: *const i8, _: *const i8) -> i64 { 0 }");
        self.writeln("unsafe fn __collate_char_stub_destructor(_: *mut collate_char_) {}");
        self.writeln("static COLLATE_CHAR_STUB_BASE_IDS: [u64; 1] = [0];");
        self.writeln("pub static STD_COLLATE_BYNAME_CHAR__VTABLE: collate_char__vtable = collate_char__vtable {");
        self.writeln("    __type_id: 0, __base_count: 1, __base_type_ids: &COLLATE_CHAR_STUB_BASE_IDS,");
        self.writeln("    do_compare: __collate_char_stub_do_compare,");
        self.writeln("    do_transform: __collate_char_stub_do_transform,");
        self.writeln("    do_hash: __collate_char_stub_do_hash,");
        self.writeln("    __destructor: __collate_char_stub_destructor,");
        self.writeln("};");
        self.writeln("");
        self.writeln("unsafe fn __collate_wchar_t_stub_do_compare(_: *const collate_wchar_t_, _: *const i32, _: *const i32, _: *const i32, _: *const i32) -> i32 { 0 }");
        self.writeln("unsafe fn __collate_wchar_t_stub_do_transform(_: *const collate_wchar_t_, _: *const i32, _: *const i32) -> std::ffi::c_void { std::mem::zeroed() }");
        self.writeln("unsafe fn __collate_wchar_t_stub_do_hash(_: *const collate_wchar_t_, _: *const i32, _: *const i32) -> i64 { 0 }");
        self.writeln("unsafe fn __collate_wchar_t_stub_destructor(_: *mut collate_wchar_t_) {}");
        self.writeln("static COLLATE_WCHAR_T_STUB_BASE_IDS: [u64; 1] = [0];");
        self.writeln("pub static STD_COLLATE_BYNAME_WCHAR_T__VTABLE: collate_wchar_t__vtable = collate_wchar_t__vtable {");
        self.writeln("    __type_id: 0, __base_count: 1, __base_type_ids: &COLLATE_WCHAR_T_STUB_BASE_IDS,");
        self.writeln("    do_compare: __collate_wchar_t_stub_do_compare,");
        self.writeln("    do_transform: __collate_wchar_t_stub_do_transform,");
        self.writeln("    do_hash: __collate_wchar_t_stub_do_hash,");
        self.writeln("    __destructor: __collate_wchar_t_stub_destructor,");
        self.writeln("};");
        self.writeln("");
        // ctype vtable constants
        self.writeln("unsafe fn __ctype_char_stub_do_toupper(_: *const ctype_char_, c: i8) -> i8 { c }");
        self.writeln("unsafe fn __ctype_char_stub_do_toupper_1(_: *const ctype_char_, _: *mut i8, e: *const i8) -> *const i8 { e }");
        self.writeln("unsafe fn __ctype_char_stub_do_tolower(_: *const ctype_char_, c: i8) -> i8 { c }");
        self.writeln("unsafe fn __ctype_char_stub_do_tolower_1(_: *const ctype_char_, _: *mut i8, e: *const i8) -> *const i8 { e }");
        self.writeln("unsafe fn __ctype_char_stub_destructor(_: *mut ctype_char_) {}");
        self.writeln("static CTYPE_CHAR_STUB_BASE_IDS: [u64; 1] = [0];");
        self.writeln("pub static STD_CTYPE_CHAR__VTABLE: ctype_char__vtable = ctype_char__vtable {");
        self.writeln("    __type_id: 0, __base_count: 1, __base_type_ids: &CTYPE_CHAR_STUB_BASE_IDS,");
        self.writeln("    do_toupper: __ctype_char_stub_do_toupper,");
        self.writeln("    do_toupper_1: __ctype_char_stub_do_toupper_1,");
        self.writeln("    do_tolower: __ctype_char_stub_do_tolower,");
        self.writeln("    do_tolower_1: __ctype_char_stub_do_tolower_1,");
        self.writeln("    __destructor: __ctype_char_stub_destructor,");
        self.writeln("};");
        self.writeln("pub static STD_CTYPE_BYNAME_CHAR__VTABLE: ctype_char__vtable = ctype_char__vtable {");
        self.writeln("    __type_id: 0, __base_count: 1, __base_type_ids: &CTYPE_CHAR_STUB_BASE_IDS,");
        self.writeln("    do_toupper: __ctype_char_stub_do_toupper,");
        self.writeln("    do_toupper_1: __ctype_char_stub_do_toupper_1,");
        self.writeln("    do_tolower: __ctype_char_stub_do_tolower,");
        ...
        self.writeln("};");
        self.writeln("");
        self.writeln("unsafe fn __ctype_wchar_t_stub_do_is(_: *const ctype_wchar_t_, _: u32, _: i32) -> bool { false }");
        self.writeln("unsafe fn __ctype_wchar_t_stub_do_is_1(_: *const ctype_wchar_t_, _: *const i32, e: *const i32, _: *mut u32) -> *const i32 { e }");
        self.writeln("unsafe fn __ctype_wchar_t_stub_do_scan_is(_: *const ctype_wchar_t_, _: u32, _: *const i32, e: *const i32) -> *const i32 { e }");
        self.writeln("unsafe fn __ctype_wchar_t_stub_do_scan_not(_: *const ctype_wchar_t_, _: u32, _: *const i32, e: *const i32) -> *const i32 { e }");
        self.writeln("unsafe fn __ctype_wchar_t_stub_do_toupper(_: *const ctype_wchar_t_, c: i32) -> i32 { c }");
        self.writeln("unsafe fn __ctype_wchar_t_stub_do_toupper_1(_: *const ctype_wchar_t_, _: *mut i32, e: *const i32) -> *const i32 { e }");
        self.writeln("unsafe fn __ctype_wchar_t_stub_do_tolower(_: *const ctype_wchar_t_, c: i32) -> i32 { c }");
        self.writeln("unsafe fn __ctype_wchar_t_stub_do_tolower_1(_: *const ctype_wchar_t_, _: *mut i32, e: *const i32) -> *const i32 { e }");
        self.writeln("unsafe fn __ctype_wchar_t_stub_do_widen(_: *const ctype_wchar_t_, c: i8) -> i32 { c as i32 }");
        self.writeln("unsafe fn __ctype_wchar_t_stub_do_widen_1(_: *const ctype_wchar_t_, _: *const i8, e: *const i8, _: *mut i32) -> *const i8 { e }");
        self.writeln("unsafe fn __ctype_wchar_t_stub_do_narrow(_: *const ctype_wchar_t_, _: i32, d: i8) -> i8 { d }");
        self.writeln("unsafe fn __ctype_wchar_t_stub_do_narrow_1(_: *const ctype_wchar_t_, _: *const i32, e: *const i32, _: i8, _: *mut i8) -> *const i32 { e }");
        self.writeln("unsafe fn __ctype_wchar_t_stub_destructor(_: *mut ctype_wchar_t_) {}");
        self.writeln("static CTYPE_WCHAR_T_STUB_BASE_IDS: [u64; 1] = [0];");
        self.writeln("pub static STD_CTYPE_WCHAR_T__VTABLE: ctype_wchar_t__vtable = ctype_wchar_t__vtable {");
        self.writeln("    __type_id: 0, __base_count: 1, __base_type_ids: &CTYPE_WCHAR_T_STUB_BASE_IDS,");
        self.writeln("    do_is: __ctype_wchar_t_stub_do_is,");
        self.writeln("    do_is_1: __ctype_wchar_t_stub_do_is_1,");
        self.writeln("    do_scan_is: __ctype_wchar_t_stub_do_scan_is,");
        self.writeln("    do_scan_not: __ctype_wchar_t_stub_do_scan_not,");
        self.writeln("    do_toupper: __ctype_wchar_t_stub_do_toupper,");
        self.writeln("    do_toupper_1: __ctype_wchar_t_stub_do_toupper_1,");
        self.writeln("    do_tolower: __ctype_wchar_t_stub_do_tolower,");
        self.writeln("    do_tolower_1: __ctype_wchar_t_stub_do_tolower_1,");
        self.writeln("    do_widen: __ctype_wchar_t_stub_do_widen,");
        self.writeln("    do_widen_1: __ctype_wchar_t_stub_do_widen_1,");
        self.writeln("    do_narrow: __ctype_wchar_t_stub_do_narrow,");
        self.writeln("    do_narrow_1: __ctype_wchar_t_stub_do_narrow_1,");
        self.writeln("    __destructor: __ctype_wchar_t_stub_destructor,");
        self.writeln("};");
        self.writeln("pub static STD_CTYPE_BYNAME_WCHAR_T__VTABLE: ctype_wchar_t__vtable = ctype_wchar_t__vtable {");
        self.writeln("    __type_id: 0, __base_count: 1, __base_type_ids: &CTYPE_WCHAR_T_STUB_BASE_IDS,");
        self.writeln("    do_is: __ctype_wchar_t_stub_do_is,");
        self.writeln("    do_is_1: __ctype_wchar_t_stub_do_is_1,");
        self.writeln("    do_scan_is: __ctype_wchar_t_stub_do_scan_is,");
