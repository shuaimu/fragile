...
- [ ] 5) Cast/decay/call-shape lowering bugs. Status: OPEN (partially mitigated). Evidence: constructor-path, degraded non-constructor array-decay, and non-constructor value-to-pointer call-shape regressions are now covered/fixed in 5.1/5.2/5.3; final class-clearance validation remains tracked in 5.4.
