...
- [x] **Mako Tests**: 40 test executables, 694 tests [26:01:17]
...
- [-] **G.6.1 Unit Tests (ctest)**
  ...
  - [ ] All tests pass (40 executables, 694 tests)
...
- Total: 40 test executables, 694 tests passing
...
- G.5.2: Unit tests (40 executables, 694 tests)
