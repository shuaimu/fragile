...
- [x] fragile-rustc-driver: 14 tests passing with rustc-integration feature (11 base + 3 rustc_integration tests)
...
- **Total tests**: 596 fragile-clang (27 unit + 569 integration), 14 fragile-rustc-driver with feature
