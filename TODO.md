  ...
  - [ ] 5.4.c) Fix LibTooling-primary regressions until parity with current strict baseline (Effort: M, Risk: High).
    - [ ] 5.4.c.i) Resolve top-ranked unresolved-name/type and call-shape regressions surfaced by 5.4.b manifests and keep replay deltas non-increasing.
      ...
      - [ ] 5.4.c.i.3) Fix the highest-impact unresolved-name/type or call-shape delta from 5.4.c.i.2 in LibTooling-primary output and lock it with focused parser/codegen regressions.
        ...
        - [ ] 5.4.c.i.3.c) Implement hotspot-targeted parser/codegen fix from 5.4.c.i.3.b and require direct `capitalize.cpp` LibTooling replay to emit a sidecar within timeout bounds (no `compile_timeout`).
      - [ ] 5.4.c.i.4) Re-run strict backend-matrix replay and require delta manifest non-increase (`configure/build/class/E0425`, plus timeout incidence) vs current baseline.
