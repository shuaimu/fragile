...
- [ ] M5.A1 All placeholder nodes in corpus resolve to generated STL targets.
  ...
  - [ ] M5.A1.b Expand mapping-completeness covered-family enforcement to remaining mapped placeholder families (`string`, `optional`, `variant`, `tuple`) with deterministic positive/negative regressions.
