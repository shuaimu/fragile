# RPC Compile Blocker Leaf 2.6.c.iv.d.iv.c.iv.c.iii.b Design (2026-03-13)

## Scope and sizing

Leaf: `2.6.c.iv.d.iv.c.iv.c.iii.b`

This is a replay/inventory verification leaf with no expected parser/codegen
source edits and therefore well below the requested LOC threshold.

## Problem

After finishing leaf `2.6.c.iv.d.iv.c.iv.c.iii.a`, we must verify that strict
build-only replay and blocker inventory metrics do not regress versus the
established `2.6.c.iii` baseline.
...
- full suite parity:
  - `cargo test --workspace --all-targets`: `fragile-clang` lib `730 passed / 46 failed` (unchanged known baseline)
  - Python suite: `Ran 29 tests`, `OK (skipped=1)`

## Outcome

Leaf `2.6.c.iv.d.iv.c.iv.c.iii.b` is complete. Blocker class/E0425 metrics are
non-worsening versus baseline and strict replay remains timeout-bound on
