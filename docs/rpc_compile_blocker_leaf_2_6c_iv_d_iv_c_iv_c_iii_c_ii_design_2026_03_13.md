# RPC Compile Blocker Leaf 2.6.c.iv.d.iv.c.iv.c.iii.c.ii Design (2026-03-13)

## Scope and sizing

Leaf: `2.6.c.iv.d.iv.c.iv.c.iii.c.ii`
...
After finishing leaf `2.6.c.iv.d.iv.c.iv.c.iii.c.i`, we must verify that strict
build-only replay and blocker inventory metrics remain non-regressive versus
the established `2.6.c.iii` baseline manifest.
...
- full suite parity:
  - `cargo test --workspace --all-targets`: `fragile-clang` lib `732 passed / 46 failed` (unchanged known baseline)
  - Python suite: `Ran 29 tests`, `OK (skipped=1)`

## Outcome

Leaf `2.6.c.iv.d.iv.c.iv.c.iii.c.ii` is complete. Blocker class/E0425 metrics
remain non-worsening versus baseline and strict replay remains timeout-bound on
