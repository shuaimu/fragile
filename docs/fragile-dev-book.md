...
## 2026-03-16: Strict RPC Build-Timeout Loop Iteration (Leaf 2.6.d...c.c.c.c.c.c.c.c.c.c.c.c.a/.b)

Context:
- Continued the strict `src/rrr/base/misc.cpp` timeout loop under `2.6.d.b.ii.c.c.v.b.iii.c.c.c.c.c.c.c.c.c.c.c.c`.
- Executed leaf `.a` (next generic hot-path reduction) followed by leaf `.b` (strict replay + non-increase checks).
...
Design change (generic hot-path):
- File: `crates/fragile-clang/src/ast_codegen.rs`
- Updated `find_next_sanitization_trigger(...)` by adding a 128-byte pass-window fast path via four existing `find_next_sanitization_trigger_in_pass_window_32(...)` probes at offsets `+0/+32/+64/+96`, ahead of existing 64-byte/32-byte/16-byte/8-byte/4-byte/tail scans.
- Semantics are unchanged; this reduces trigger-scan dispatch checks on long clean spans.

Focused regressions:
- Added `test_find_next_sanitization_trigger_handles_one_hundred_twenty_eight_byte_window_boundaries`.
- Revalidated related behavior:
  - `cargo test -p fragile-clang test_find_next_sanitization_trigger_handles_ -- --nocapture`
...
- Release build:
  - `cargo build --release -p fragile-cli --bin fragilec`
- Strict build-only harness:
  - `FRAGILEC_MODE=strict python3 scripts/mako_rpcbench_harness.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --build-only --jobs 4 --build-timeout-seconds 600`
...
- Non-increase inventory gate vs prior baseline:
  - `python3 scripts/mako_rpc_compile_blocker_inventory.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --baseline-manifest /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1/rpc_compile_blocker_inventory_manifest.txt --enforce-nonincreasing`
  - observed: `INVENTORY_STATUS=0`, `lane_fragilec_first_failing_compile_class=build_timeout`, `lane_fragilec_first_failing_compile_file=src/rrr/base/misc.cpp`, `lane_fragilec_class_rank_delta_vs_baseline=0`, `lane_fragilec_e0425_delta_vs_baseline=0`, `lane_fragilec_nonincrease_gate_pass=true`, `nonincrease_gate_pass=true`
- Blocker replay:
  - `python3 scripts/mako_rpc_compile_blocker_replay.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --max-replays 1 --timeout-seconds 300`
  - observed: `REPLAY_STATUS=0`, `replay_01_blocker_class=build_timeout`, `replay_01_blocker_file=src/rrr/base/misc.cpp`, `replay_01_status=124`, `replay_01_timed_out=true`, `replay_01_first_failure_class=build_timeout`

Full-suite sweep (step 4):
- Workspace capture:
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_b_workspace_20260316_v1 --name workspace_all_targets --inactivity-timeout-seconds 90 --wall-timeout-seconds 1200 --command cargo test --workspace --all-targets`
  - observed: `WS_CAPTURE_STATUS=124`, `workspace_all_targets.status=124`, `timeout_reason=inactivity_timeout`
  - first failing ids: `test_e2e_object_pool`, `test_e2e_trie`, `test_e2e_tokenizer`, `test_e2e_simple_hash_table`, `test_e2e_simple_graph`, `test_variadic_template_transpile`, `test_e2e_pthread`.
- Python suite:
  - `python3 -m unittest discover -s tests/python -p 'test_*.py'`
  - observed: `PY_STATUS=0`, `Ran 34 tests`, `OK`, `skipped=1`.

## 2026-03-16: Strict RPC Build-Timeout Loop Iteration (Leaf 2.6.d...c.c.c.c.c.c.c.c.c.c.c.a/.b)

Context:
- Continued the strict `src/rrr/base/misc.cpp` timeout loop under `2.6.d.b.ii.c.c.v.b.iii.c.c.c.c.c.c.c.c.c.c.c`.
...
Design change (generic hot-path):
- File: `crates/fragile-clang/src/ast_codegen.rs`
- Added `find_next_sanitization_trigger_in_pass_window_32(...)` and reused it in `find_next_sanitization_trigger(...)` to add a 64-byte fast path (two 32-byte pass-window probes) ahead of existing 32-byte/16-byte/8-byte/4-byte/tail scans.
- Semantics are unchanged; this reduces pass-through action-table dispatch work on long clean spans before trigger bytes.

Focused regressions:
- Added `test_find_next_sanitization_trigger_handles_sixty_four_byte_window_boundaries`.
- Revalidated related behavior:
  - `cargo test -p fragile-clang test_find_next_sanitization_trigger_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_find_type_sanitization_run_end_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_append_sanitized_type_for_fn_name_ -- --nocapture`
...
- Release build:
  - `cargo build --release -p fragile-cli --bin fragilec`
- Strict build-only harness:
  - `FRAGILEC_MODE=strict python3 scripts/mako_rpcbench_harness.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --build-only --jobs 4 --build-timeout-seconds 600`
  - observed: `HARNESS_STATUS=1`, `lane_fragilec_build_status=124`, `lane_fragilec_test_rpc_status=-1`, `lane_fragilec_failure_class=build_timeout`
- Non-increase inventory gate vs prior baseline:
  - `python3 scripts/mako_rpc_compile_blocker_inventory.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --baseline-manifest /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1/rpc_compile_blocker_inventory_manifest.txt --enforce-nonincreasing`
  - observed: `INVENTORY_STATUS=0`, `lane_fragilec_first_failing_compile_class=build_timeout`, `lane_fragilec_first_failing_compile_file=src/rrr/base/misc.cpp`, `lane_fragilec_class_rank_delta_vs_baseline=0`, `lane_fragilec_e0425_delta_vs_baseline=0`, `lane_fragilec_nonincrease_gate_pass=true`, `nonincrease_gate_pass=true`
- Blocker replay:
  - `python3 scripts/mako_rpc_compile_blocker_replay.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --max-replays 1 --timeout-seconds 300`
  - observed: `REPLAY_STATUS=0`, `replay_01_blocker_class=build_timeout`, `replay_01_blocker_file=src/rrr/base/misc.cpp`, `replay_01_status=124`, `replay_01_timed_out=true`, `replay_01_first_failure_class=build_timeout`

Full-suite sweep (step 4):
- Workspace capture:
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_b_workspace_20260316_v1 --name workspace_all_targets --inactivity-timeout-seconds 90 --wall-timeout-seconds 1200 --command cargo test --workspace --all-targets`
  - observed: `WS_CAPTURE_STATUS=124`, `workspace_all_targets.status=124`, `timeout_reason=inactivity_timeout`
  - first failing ids: `test_e2e_trie`, `test_e2e_simple_hash_table`, `test_e2e_object_pool`, `test_e2e_simple_graph`, `test_e2e_tokenizer`, `test_variadic_template_transpile`, `test_e2e_pthread`.
- Python suite:
  - `python3 -m unittest discover -s tests/python -p 'test_*.py'`
  - observed: `Ran 34 tests`, `OK`, `skipped=1`.
...
## 2026-03-16: Strict RPC Build-Timeout Loop Iteration (Leaf 2.6.d...c.c.c.c.c.c.c.a/.b)

Context:
- Continued the strict `src/rrr/base/misc.cpp` timeout loop under `2.6.d.b.ii.c.c.v.b.iii.c.c.c.c.c.c.c`.
- Decomposed the repeat controller into bounded leaves (`.a/.b/.c`) and executed `.a` then `.b`.
...
Design change (generic hot-path):
- File: `crates/fragile-clang/src/ast_codegen.rs`
- Updated `find_type_sanitization_run_end(...)` by adding 8-byte and 4-byte unrolled scans ahead of the tail scan.
- Semantics are unchanged; this only reduces per-byte branch/dispatch overhead when sanitizer actions form dense runs (`UNDERSCORE`, `DROP`, `REF`).

Focused regressions:
- Added `test_find_type_sanitization_run_end_handles_unrolled_boundaries`.
- Revalidated related behavior:
  - `cargo test -p fragile-clang test_find_type_sanitization_run_end_handles_unrolled_boundaries -- --nocapture`
  - `cargo test -p fragile-clang test_find_next_sanitization_trigger_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_append_sanitized_type_for_fn_name_ -- --nocapture`
  - `cargo test -p fragile-clang test_type_sanitization_action_table_matches_legacy_for_all_bytes -- --nocapture`
  - `cargo test -p fragile-clang test_build_fn_template_mangled_name_ -- --nocapture`
...
- Release build:
  - `cargo build --release -p fragile-cli --bin fragilec`
- Strict build-only harness:
  - `FRAGILEC_MODE=strict python3 scripts/mako_rpcbench_harness.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --build-only --jobs 4 --build-timeout-seconds 600`
  - observed: `HARNESS_STATUS=1`, `lane_fragilec_build_status=124`, `lane_fragilec_test_rpc_status=-1`, `lane_fragilec_failure_class=build_timeout`
- Non-increase inventory gate vs prior baseline:
  - `python3 scripts/mako_rpc_compile_blocker_inventory.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --baseline-manifest /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_b_build_only_20260316_v1/rpc_compile_blocker_inventory_manifest.txt --enforce-nonincreasing`
  - observed: `INVENTORY_STATUS=0`, `lane_fragilec_first_failing_compile_class=build_timeout`, `lane_fragilec_first_failing_compile_file=src/rrr/base/misc.cpp`, `lane_fragilec_class_rank_delta_vs_baseline=0`, `lane_fragilec_e0425_delta_vs_baseline=0`, `lane_fragilec_nonincrease_gate_pass=true`, `nonincrease_gate_pass=true`
- Blocker replay:
  - `python3 scripts/mako_rpc_compile_blocker_replay.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --max-replays 1 --timeout-seconds 300`
  - observed: `REPLAY_STATUS=0`, `replay_01_blocker_class=build_timeout`, `replay_01_blocker_file=src/rrr/base/misc.cpp`, `replay_01_status=124`, `replay_01_timed_out=true`, `replay_01_first_failure_class=build_timeout`

Full-suite sweep (step 4):
- Workspace capture:
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_b_workspace_20260316_v1 --name workspace_all_targets --inactivity-timeout-seconds 90 --wall-timeout-seconds 1200 --command cargo test --workspace --all-targets`
  - observed: `WS_CAPTURE_STATUS=124`, `workspace_all_targets.status=124`, `timeout_reason=inactivity_timeout`
  - first failing ids: `test_e2e_object_pool`, `test_e2e_simple_hash_table`, `test_e2e_trie`, `test_e2e_simple_graph`, `test_e2e_tokenizer`, `test_variadic_template_transpile`, `test_e2e_pthread`.
- Python suite:
  - `python3 -m unittest discover -s tests/python -p 'test_*.py'`
  - observed: `PY_STATUS=0`, `Ran 34 tests`, `OK`, `skipped=1`.

## 2026-03-16: Strict RPC Build-Timeout Loop Iteration (Leaf 2.6.d...c.c.c.c.c.c.c.c.a/.b)

Context:
- Continued the strict `src/rrr/base/misc.cpp` timeout loop under `2.6.d.b.ii.c.c.v.b.iii.c.c.c.c.c.c.c.c`.
- Decomposed the repeat controller into bounded leaves (`.a/.b/.c`) and executed `.a` then `.b`.
...
Design change (generic hot-path):
- File: `crates/fragile-clang/src/ast_codegen.rs`
- Updated `find_type_sanitization_run_end(...)` by adding a 16-byte unrolled scan ahead of existing 8-byte/4-byte/tail scans.
- Semantics are unchanged; this only reduces per-byte action-table checks on long dense sanitizer-action runs.

Focused regressions:
- Added `test_find_type_sanitization_run_end_handles_sixteen_byte_window_boundaries`.
- Revalidated related behavior:
  - `cargo test -p fragile-clang test_find_type_sanitization_run_end_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_find_next_sanitization_trigger_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_append_sanitized_type_for_fn_name_ -- --nocapture`
...
- Release build:
  - `cargo build --release -p fragile-cli --bin fragilec`
- Strict build-only harness:
  - `FRAGILEC_MODE=strict python3 scripts/mako_rpcbench_harness.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --build-only --jobs 4 --build-timeout-seconds 600`
  - observed: `HARNESS_STATUS=1`, `lane_fragilec_build_status=124`, `lane_fragilec_test_rpc_status=-1`, `lane_fragilec_failure_class=build_timeout`
- Non-increase inventory gate vs prior baseline:
  - `python3 scripts/mako_rpc_compile_blocker_inventory.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --baseline-manifest /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_b_build_only_20260316_v1/rpc_compile_blocker_inventory_manifest.txt --enforce-nonincreasing`
  - observed: `INVENTORY_STATUS=0`, `lane_fragilec_first_failing_compile_class=build_timeout`, `lane_fragilec_first_failing_compile_file=src/rrr/base/misc.cpp`, `lane_fragilec_class_rank_delta_vs_baseline=0`, `lane_fragilec_e0425_delta_vs_baseline=0`, `lane_fragilec_nonincrease_gate_pass=true`, `nonincrease_gate_pass=true`
- Blocker replay:
  - `python3 scripts/mako_rpc_compile_blocker_replay.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --max-replays 1 --timeout-seconds 300`
  - observed: `REPLAY_STATUS=0`, `replay_01_blocker_class=build_timeout`, `replay_01_blocker_file=src/rrr/base/misc.cpp`, `replay_01_status=124`, `replay_01_timed_out=true`, `replay_01_first_failure_class=build_timeout`

Full-suite sweep (step 4):
- Workspace capture:
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_b_workspace_20260316_v1 --name workspace_all_targets --inactivity-timeout-seconds 90 --wall-timeout-seconds 1200 --command cargo test --workspace --all-targets`
  - observed: `WS_CAPTURE_STATUS=124`, `workspace_all_targets.status=124`, `timeout_reason=inactivity_timeout`
  - first failing ids: `test_e2e_simple_graph`, `test_e2e_trie`, `test_e2e_object_pool`, `test_e2e_simple_hash_table`, `test_e2e_tokenizer`, `test_variadic_template_transpile`, `test_e2e_pthread`.
- Python suite:
  - `python3 -m unittest discover -s tests/python -p 'test_*.py'`
  - observed: `PY_STATUS=0`, `Ran 34 tests`, `OK`, `skipped=1`.

## 2026-03-16: Strict RPC Build-Timeout Loop Iteration (Leaf 2.6.d...c.c.c.c.c.c.c.c.c.a/.b)

Context:
- Continued the strict `src/rrr/base/misc.cpp` timeout loop under `2.6.d.b.ii.c.c.v.b.iii.c.c.c.c.c.c.c.c.c`.
- Decomposed the repeat controller into bounded leaves (`.a/.b/.c`) and executed `.a` then `.b`.
...
Design change (generic hot-path):
- File: `crates/fragile-clang/src/ast_codegen.rs`
- Updated `find_type_sanitization_run_end(...)` by adding a 32-byte unrolled scan ahead of existing 16-byte/8-byte/4-byte/tail scans.
- Semantics are unchanged; this only reduces per-byte action-table checks on long dense sanitizer-action runs.

Focused regressions:
- Added `test_find_type_sanitization_run_end_handles_thirty_two_byte_window_boundaries`.
- Revalidated related behavior:
  - `cargo test -p fragile-clang test_find_type_sanitization_run_end_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_find_next_sanitization_trigger_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_append_sanitized_type_for_fn_name_ -- --nocapture`
...
- Release build:
  - `cargo build --release -p fragile-cli --bin fragilec`
- Strict build-only harness:
  - `FRAGILEC_MODE=strict python3 scripts/mako_rpcbench_harness.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --build-only --jobs 4 --build-timeout-seconds 600`
  - observed: `HARNESS_STATUS=1`, `lane_fragilec_build_status=124`, `lane_fragilec_test_rpc_status=-1`, `lane_fragilec_failure_class=build_timeout`
- Non-increase inventory gate vs prior baseline:
  - `python3 scripts/mako_rpc_compile_blocker_inventory.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --baseline-manifest /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_b_build_only_20260316_v1/rpc_compile_blocker_inventory_manifest.txt --enforce-nonincreasing`
  - observed: `INVENTORY_STATUS=0`, `lane_fragilec_first_failing_compile_class=build_timeout`, `lane_fragilec_first_failing_compile_file=src/rrr/base/misc.cpp`, `lane_fragilec_class_rank_delta_vs_baseline=0`, `lane_fragilec_e0425_delta_vs_baseline=0`, `lane_fragilec_nonincrease_gate_pass=true`, `nonincrease_gate_pass=true`
- Blocker replay:
  - `python3 scripts/mako_rpc_compile_blocker_replay.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --max-replays 1 --timeout-seconds 300`
  - observed: `REPLAY_STATUS=0`, `replay_01_blocker_class=build_timeout`, `replay_01_blocker_file=src/rrr/base/misc.cpp`, `replay_01_status=124`, `replay_01_timed_out=true`, `replay_01_first_failure_class=build_timeout`

Full-suite sweep (step 4):
- Workspace capture:
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_b_workspace_20260316_v1 --name workspace_all_targets --inactivity-timeout-seconds 90 --wall-timeout-seconds 1200 --command cargo test --workspace --all-targets`
  - observed: `WS_CAPTURE_STATUS=124`, `workspace_all_targets.status=124`, `timeout_reason=inactivity_timeout`
  - first failing ids: `test_e2e_object_pool`, `test_e2e_simple_hash_table`, `test_e2e_tokenizer`, `test_e2e_trie`, `test_e2e_simple_graph`, `test_variadic_template_transpile`, `test_e2e_pthread`.
- Python suite:
  - `python3 -m unittest discover -s tests/python -p 'test_*.py'`
  - observed: `PY_STATUS=0`, `Ran 34 tests`, `OK`, `skipped=1`.

## 2026-03-16: Strict RPC Build-Timeout Loop Iteration (Leaf 2.6.d...c.c.c.c.c.c.c.c.c.c.a/.b)

Context:
- Continued the strict `src/rrr/base/misc.cpp` timeout loop under `2.6.d.b.ii.c.c.v.b.iii.c.c.c.c.c.c.c.c.c.c`.
- Decomposed the repeat controller into bounded leaves (`.a/.b/.c`) and executed `.a` then `.b`.
...
Design change (generic hot-path):
- File: `crates/fragile-clang/src/ast_codegen.rs`
- Updated `find_type_sanitization_run_end(...)` by adding a 64-byte unrolled scan ahead of existing 32-byte/16-byte/8-byte/4-byte/tail scans.
- Semantics are unchanged; this only reduces per-byte action-table checks on long dense sanitizer-action runs.

Focused regressions:
- Added `test_find_type_sanitization_run_end_handles_sixty_four_byte_window_boundaries`.
- Revalidated related behavior:
  - `cargo test -p fragile-clang test_find_type_sanitization_run_end_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_find_next_sanitization_trigger_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_append_sanitized_type_for_fn_name_ -- --nocapture`
...
- Release build:
  - `cargo build --release -p fragile-cli --bin fragilec`
- Strict build-only harness:
  - `FRAGILEC_MODE=strict python3 scripts/mako_rpcbench_harness.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --build-only --jobs 4 --build-timeout-seconds 600`
  - observed: `HARNESS_STATUS=1`, `lane_fragilec_build_status=124`, `lane_fragilec_test_rpc_status=-1`, `lane_fragilec_failure_class=build_timeout`
- Non-increase inventory gate vs prior baseline:
  - `python3 scripts/mako_rpc_compile_blocker_inventory.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --baseline-manifest /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1/rpc_compile_blocker_inventory_manifest.txt --enforce-nonincreasing`
  - observed: `INVENTORY_STATUS=0`, `lane_fragilec_first_failing_compile_class=build_timeout`, `lane_fragilec_first_failing_compile_file=src/rrr/base/misc.cpp`, `lane_fragilec_class_rank_delta_vs_baseline=0`, `lane_fragilec_e0425_delta_vs_baseline=0`, `lane_fragilec_nonincrease_gate_pass=true`, `nonincrease_gate_pass=true`
- Blocker replay:
  - `python3 scripts/mako_rpc_compile_blocker_replay.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --max-replays 1 --timeout-seconds 300`
  - observed: `REPLAY_STATUS=0`, `replay_01_blocker_class=build_timeout`, `replay_01_blocker_file=src/rrr/base/misc.cpp`, `replay_01_status=124`, `replay_01_timed_out=true`, `replay_01_first_failure_class=build_timeout`

Full-suite sweep (step 4):
- Workspace capture:
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_b_workspace_20260316_v1 --name workspace_all_targets --inactivity-timeout-seconds 90 --wall-timeout-seconds 1200 --command cargo test --workspace --all-targets`
  - observed: `WS_CAPTURE_STATUS=124`, `workspace_all_targets.status=124`, `timeout_reason=inactivity_timeout`
  - first failing ids: `test_e2e_simple_graph`, `test_e2e_object_pool`, `test_e2e_trie`, `test_e2e_simple_hash_table`, `test_e2e_tokenizer`, `test_variadic_template_transpile`, `test_e2e_pthread`.
- Python suite:
  - `python3 -m unittest discover -s tests/python -p 'test_*.py'`
  - observed: `PY_STATUS=0`, `Ran 34 tests`, `OK`, `skipped=1`.

## 2026-03-16: Strict RPC Build-Timeout Loop Iteration (Leaf 2.6.d...c.c.c.c.c.c.c.c.c.c.c.c.c.a/.b)

Context:
- Continued the strict `src/rrr/base/misc.cpp` timeout loop under `2.6.d.b.ii.c.c.v.b.iii.c.c.c.c.c.c.c.c.c.c.c.c.c`.
- Executed leaf `.a` (next generic hot-path reduction) followed by `.b` (strict replay + non-increase evidence capture).
...
Design change (generic hot-path):
- File: `crates/fragile-clang/src/ast_codegen.rs`
- Updated `find_next_sanitization_trigger(...)` by adding a 256-byte pass-window fast path using existing 32-byte window helper probes at offsets `+0/+32/+64/+96/+128/+160/+192/+224`, ahead of the existing 128-byte/64-byte/32-byte/16-byte/8-byte/4-byte/tail scans.
- Semantics are unchanged; this only reduces trigger-scan dispatch checks on long clean spans.

Focused regressions:
- Added `test_find_next_sanitization_trigger_handles_two_hundred_fifty_six_byte_window_boundaries`.
- Revalidated related behavior:
  - `cargo test -p fragile-clang test_find_next_sanitization_trigger_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_find_type_sanitization_run_end_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_append_sanitized_type_for_fn_name_ -- --nocapture`
...
- Release build:
  - `cargo build --release -p fragile-cli --bin fragilec`
- Strict build-only harness:
  - `FRAGILEC_MODE=strict python3 scripts/mako_rpcbench_harness.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --build-only --jobs 4 --build-timeout-seconds 600`
  - observed: `HARNESS_STATUS=1`, `lane_fragilec_configure_status=0`, `lane_fragilec_clean_status=0`, `lane_fragilec_build_status=124`, `lane_fragilec_test_rpc_status=-1`, `lane_fragilec_failure_class=build_timeout`
- Non-increase inventory gate vs prior baseline:
  - `python3 scripts/mako_rpc_compile_blocker_inventory.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --baseline-manifest /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1/rpc_compile_blocker_inventory_manifest.txt --enforce-nonincreasing`
  - observed: `INVENTORY_STATUS=0`, `lane_fragilec_first_failing_compile_class=build_timeout`, `lane_fragilec_first_failing_compile_file=src/rrr/base/misc.cpp`, `lane_fragilec_class_rank_delta_vs_baseline=0`, `lane_fragilec_e0425_delta_vs_baseline=0`, `lane_fragilec_nonincrease_gate_pass=true`, `nonincrease_gate_pass=true`
- Blocker replay:
  - `python3 scripts/mako_rpc_compile_blocker_replay.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --max-replays 1 --timeout-seconds 300`
  - observed: `REPLAY_STATUS=0`, `replay_01_blocker_class=build_timeout`, `replay_01_blocker_file=src/rrr/base/misc.cpp`, `replay_01_status=124`, `replay_01_timed_out=true`, `replay_01_first_failure_class=build_timeout`

Full-suite sweep (step 4):
- Workspace capture:
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_b_workspace_20260316_v1 --name workspace_all_targets --inactivity-timeout-seconds 90 --wall-timeout-seconds 1200 --command cargo test --workspace --all-targets`
  - observed: `WS_CAPTURE_STATUS=124`, `workspace_all_targets.status=124`, `timeout_reason=inactivity_timeout`
  - first failing ids: `test_e2e_simple_graph`, `test_e2e_simple_hash_table`, `test_e2e_trie`, `test_e2e_object_pool`, `test_e2e_tokenizer`, `test_variadic_template_transpile`, `test_e2e_pthread`
- Python suite:
  - `python3 -m unittest discover -s tests/python -p 'test_*.py'`
  - observed: `PY_STATUS=0`, `Ran 34 tests`, `OK`, `skipped=1`
...
Context:
- Continued the strict `src/rrr/base/misc.cpp` timeout loop under `2.6.d.b.ii.c.c.v.b.iii.c.c.c.c.c.c.c.c.c.c.c.c.c.c.c.c.c.c`.
- Executed the first bounded leaf pair (`.a`, `.b`) for this repeat controller.

Wrong-approach check:
- Re-read `1.3 Wrong Approaches (Do Not Do)` and `docs/dev/wrong.md` before editing/replay.
- No target-specific conditionals, no force-native bypasses, and no synthesized semantic fallback bodies were introduced.

Design change (generic hot-path):
- File: `crates/fragile-clang/src/ast_codegen.rs`
- Updated `find_next_sanitization_trigger(...)` by adding an 8192-byte pass-window fast path, iterating existing reusable 32-byte probe helper calls across offsets `0..8192` in 32-byte steps, ahead of existing 4096-byte/2048-byte/1024-byte/512-byte/256-byte/128-byte/64-byte/32-byte/16-byte/8-byte/4-byte/tail scans.
- Scope stayed small (`~24` LOC in this iteration), with no semantic behavior changes intended.

Focused regressions:
- Added `test_find_next_sanitization_trigger_handles_eight_thousand_one_hundred_ninety_two_byte_window_boundaries`.
- Revalidated related behavior:
  - `cargo test -p fragile-clang test_find_next_sanitization_trigger_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_find_type_sanitization_run_end_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_append_sanitized_type_for_fn_name_ -- --nocapture`
...
- Release build:
  - `cargo build --release -p fragile-cli --bin fragilec`
- Strict build-only harness:
  - `FRAGILEC_MODE=strict python3 scripts/mako_rpcbench_harness.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --build-only --jobs 4 --build-timeout-seconds 600`
  - observed: `lane_fragilec_configure_status=0`, `lane_fragilec_clean_status=0`, `lane_fragilec_build_status=124`, `lane_fragilec_test_rpc_status=-1`, `lane_fragilec_failure_class=build_timeout`
- Non-increase inventory gate vs prior baseline:
  - `python3 scripts/mako_rpc_compile_blocker_inventory.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --baseline-manifest /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1/rpc_compile_blocker_inventory_manifest.txt --enforce-nonincreasing`
  - observed: `INVENTORY_STATUS=0`, `lane_fragilec_first_failing_compile_class=build_timeout`, `lane_fragilec_first_failing_compile_file=src/rrr/base/misc.cpp`, `lane_fragilec_class_rank_delta_vs_baseline=0`, `lane_fragilec_e0425_delta_vs_baseline=0`, `lane_fragilec_nonincrease_gate_pass=true`, `nonincrease_gate_pass=true`
- Blocker replay:
  - `python3 scripts/mako_rpc_compile_blocker_replay.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --max-replays 1 --timeout-seconds 300`
  - observed: `REPLAY_STATUS=0`, `replay_01_blocker_class=build_timeout`, `replay_01_blocker_file=src/rrr/base/misc.cpp`, `replay_01_status=124`, `replay_01_timed_out=true`, `replay_01_first_failure_class=build_timeout`

Full-suite sweep (step 4):
- Workspace capture (attempt 1):
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_workspace_20260316_v1 --name workspace_all_targets --inactivity-timeout-seconds 300 --wall-timeout-seconds 3600 --command cargo test --workspace --all-targets`
  - observed: `status=124`, `timed_out=true`, `timeout_reason=inactivity_timeout`
  - failing ids before timeout: `test_e2e_simple_hash_table`, `test_e2e_object_pool`, `test_e2e_simple_graph`, `test_e2e_trie`, `test_e2e_tokenizer`, `test_variadic_template_transpile`, `test_e2e_pthread`
- Workspace capture (attempt 2, longer inactivity budget):
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_workspace_20260316_v2 --name workspace_all_targets --inactivity-timeout-seconds 1800 --wall-timeout-seconds 7200 --command cargo test --workspace --all-targets`
  - observed: progressed into long-running `integration_test` phase with sustained CPU; same failing ids remained visible in captured output before long-run stall; run was manually terminated after extended execution window to unblock iteration.
- Python suite:
  - `python3 -m unittest discover -s tests/python -p 'test_*.py'`
  - observed: `PY_STATUS=0`, `Ran 34 tests`, `OK`, `skipped=1`

## 2026-03-16: Strict RPC Build-Timeout Loop Iteration (Leaf 2.6.d...c.c.c.c.c.c.c.c.c.c.c.c.c.c.c.c.c.a/.b)

Context:
- Continued the strict `src/rrr/base/misc.cpp` timeout loop under `2.6.d.b.ii.c.c.v.b.iii.c.c.c.c.c.c.c.c.c.c.c.c.c.c.c.c.c`.
- Executed leaf `.a` (next generic hot-path reduction) followed by `.b` (strict replay + non-increase evidence capture).
...
Design change (generic hot-path):
- File: `crates/fragile-clang/src/ast_codegen.rs`
- Updated `find_next_sanitization_trigger(...)` by adding a 4096-byte pass-window fast path, iterating existing reusable 32-byte probe helper calls across offsets `0..4096` in 32-byte steps, ahead of existing 2048-byte/1024-byte/512-byte/256-byte/128-byte/64-byte/32-byte/16-byte/8-byte/4-byte/tail scans.
- Scope stayed small (`~44` LOC in this iteration), with no semantic behavior changes intended.

Focused regressions:
- Added `test_find_next_sanitization_trigger_handles_four_thousand_ninety_six_byte_window_boundaries`.
- Revalidated related behavior:
  - `cargo test -p fragile-clang test_find_next_sanitization_trigger_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_find_type_sanitization_run_end_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_append_sanitized_type_for_fn_name_ -- --nocapture`
...
- Release build:
  - `cargo build --release -p fragile-cli --bin fragilec`
- Strict build-only harness:
  - `FRAGILEC_MODE=strict python3 scripts/mako_rpcbench_harness.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --build-only --jobs 4 --build-timeout-seconds 600`
  - observed: `lane_fragilec_configure_status=0`, `lane_fragilec_clean_status=0`, `lane_fragilec_build_status=124`, `lane_fragilec_test_rpc_status=-1`, `lane_fragilec_failure_class=build_timeout`
- Non-increase inventory gate vs prior baseline:
  - `python3 scripts/mako_rpc_compile_blocker_inventory.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --baseline-manifest /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1/rpc_compile_blocker_inventory_manifest.txt --enforce-nonincreasing`
  - observed: `INVENTORY_STATUS=0`, `lane_fragilec_first_failing_compile_class=build_timeout`, `lane_fragilec_first_failing_compile_file=src/rrr/base/misc.cpp`, `lane_fragilec_class_rank_delta_vs_baseline=0`, `lane_fragilec_e0425_delta_vs_baseline=0`, `lane_fragilec_nonincrease_gate_pass=true`, `nonincrease_gate_pass=true`
- Blocker replay:
  - `python3 scripts/mako_rpc_compile_blocker_replay.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --max-replays 1 --timeout-seconds 300`
  - observed: `REPLAY_STATUS=0`, `replay_01_blocker_class=build_timeout`, `replay_01_blocker_file=src/rrr/base/misc.cpp`, `replay_01_status=124`, `replay_01_timed_out=true`, `replay_01_first_failure_class=build_timeout`

Full-suite sweep (step 4):
- Workspace capture:
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_workspace_20260316_v1 --name workspace_all_targets --inactivity-timeout-seconds 300 --wall-timeout-seconds 3600 --command cargo test --workspace --all-targets`
  - observed: `status=124`, `timed_out=true`, `timeout_reason=inactivity_timeout`
  - failing ids before timeout: `test_e2e_object_pool`, `test_e2e_simple_graph`, `test_e2e_trie`, `test_e2e_simple_hash_table`, `test_e2e_tokenizer`, `test_variadic_template_transpile`, `test_e2e_pthread`
- Python suite:
  - `python3 -m unittest discover -s tests/python -p 'test_*.py'`
  - observed: `PY_STATUS=0`, `Ran 34 tests`, `OK`, `skipped=1`
...
Context:
- Continued the strict `src/rrr/base/misc.cpp` timeout loop under `2.6.d.b.ii.c.c.v.b.iii.c.c.c.c.c.c.c.c.c.c.c.c.c.c.c.c`.
- Executed leaf `.a` (next generic hot-path reduction) then leaf `.b` (strict replay + non-increase evidence).
...
Design change (generic hot-path):
- File: `crates/fragile-clang/src/ast_codegen.rs`
- Updated `find_next_sanitization_trigger(...)` by adding a 2048-byte pass-window fast path, iterating existing reusable 32-byte probe helper calls across offsets `0..2048` in 32-byte steps, ahead of existing 1024-byte/512-byte/256-byte/128-byte/64-byte/32-byte/16-byte/8-byte/4-byte/tail scans.
- Scope stayed small (`~44` LOC in this iteration), with no semantic behavior changes intended.

Focused regressions:
- Added `test_find_next_sanitization_trigger_handles_two_thousand_forty_eight_byte_window_boundaries`.
- Revalidated related behavior:
  - `cargo test -p fragile-clang test_find_next_sanitization_trigger_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_find_type_sanitization_run_end_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_append_sanitized_type_for_fn_name_ -- --nocapture`
...
- Release build:
  - `cargo build --release -p fragile-cli --bin fragilec`
- Strict build-only harness:
  - `FRAGILEC_MODE=strict python3 scripts/mako_rpcbench_harness.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --build-only --jobs 4 --build-timeout-seconds 600`
  - observed: `HARNESS_STATUS=1`, `lane_fragilec_configure_status=0`, `lane_fragilec_clean_status=0`, `lane_fragilec_build_status=124`, `lane_fragilec_test_rpc_status=-1`, `lane_fragilec_failure_class=build_timeout`
- Non-increase inventory gate vs prior baseline:
  - `python3 scripts/mako_rpc_compile_blocker_inventory.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --baseline-manifest /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1/rpc_compile_blocker_inventory_manifest.txt --enforce-nonincreasing`
  - observed: `INVENTORY_STATUS=0`, `lane_fragilec_first_failing_compile_class=build_timeout`, `lane_fragilec_first_failing_compile_file=src/rrr/base/misc.cpp`, `lane_fragilec_class_rank_delta_vs_baseline=0`, `lane_fragilec_e0425_delta_vs_baseline=0`, `lane_fragilec_nonincrease_gate_pass=true`, `nonincrease_gate_pass=true`
- Blocker replay:
  - `python3 scripts/mako_rpc_compile_blocker_replay.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --max-replays 1 --timeout-seconds 300`
  - observed: `REPLAY_STATUS=0`, `replay_01_blocker_class=build_timeout`, `replay_01_blocker_file=src/rrr/base/misc.cpp`, `replay_01_status=124`, `replay_01_timed_out=true`, `replay_01_first_failure_class=build_timeout`

Full-suite sweep (step 4):
- Workspace capture:
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_workspace_20260316_v2 --name workspace_all_targets --inactivity-timeout-seconds 300 --wall-timeout-seconds 3600 --command cargo test --workspace --all-targets`
  - observed: `status=124`, `timed_out=true`, `timeout_reason=inactivity_timeout`
  - failing ids before timeout: `test_e2e_simple_hash_table`, `test_e2e_object_pool`, `test_e2e_simple_graph`, `test_e2e_trie`, `test_e2e_tokenizer`, `test_variadic_template_transpile`, `test_e2e_pthread`
- Python suite:
  - `python3 -m unittest discover -s tests/python -p 'test_*.py'`
...
## 2026-03-16: Strict RPC Build-Timeout Loop Iteration (Leaf 2.6.d...c.c.c.c.c.c.c.c.c.c.c.c.c.c.a/.b)

Context:
- Continued the strict `src/rrr/base/misc.cpp` timeout loop under `2.6.d.b.ii.c.c.v.b.iii.c.c.c.c.c.c.c.c.c.c.c.c.c.c`.
- Executed leaf `.a` (next generic hot-path reduction) followed by `.b` (strict replay + non-increase evidence capture).
...
Design change (generic hot-path):
- File: `crates/fragile-clang/src/ast_codegen.rs`
- Updated `find_next_sanitization_trigger(...)` by adding a 512-byte pass-window fast path using existing 32-byte window helper probes at offsets `+0/+32/+64/+96/+128/+160/+192/+224/+256/+288/+320/+352/+384/+416/+448/+480`, ahead of existing 256-byte/128-byte/64-byte/32-byte/16-byte/8-byte/4-byte/tail scans.
- Scope stayed small (`~106` LOC in this iteration), with no semantic behavior changes intended.

Focused regressions:
- Added `test_find_next_sanitization_trigger_handles_five_hundred_twelve_byte_window_boundaries`.
- Revalidated related behavior:
  - `cargo test -p fragile-clang test_find_next_sanitization_trigger_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_find_type_sanitization_run_end_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_append_sanitized_type_for_fn_name_ -- --nocapture`
...
- Release build:
  - `cargo build --release -p fragile-cli --bin fragilec`
- Strict build-only harness:
  - `FRAGILEC_MODE=strict python3 scripts/mako_rpcbench_harness.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --build-only --jobs 4 --build-timeout-seconds 600`
  - observed: `HARNESS_STATUS=1`, `lane_fragilec_configure_status=0`, `lane_fragilec_clean_status=0`, `lane_fragilec_build_status=124`, `lane_fragilec_test_rpc_status=-1`, `lane_fragilec_failure_class=build_timeout`
- Non-increase inventory gate vs prior baseline:
  - `python3 scripts/mako_rpc_compile_blocker_inventory.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --baseline-manifest /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1/rpc_compile_blocker_inventory_manifest.txt --enforce-nonincreasing`
  - observed: `INVENTORY_STATUS=0`, `lane_fragilec_first_failing_compile_class=build_timeout`, `lane_fragilec_first_failing_compile_file=src/rrr/base/misc.cpp`, `lane_fragilec_class_rank_delta_vs_baseline=0`, `lane_fragilec_e0425_delta_vs_baseline=0`, `lane_fragilec_nonincrease_gate_pass=true`, `nonincrease_gate_pass=true`
- Blocker replay:
  - `python3 scripts/mako_rpc_compile_blocker_replay.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --max-replays 1 --timeout-seconds 300`
  - observed: `REPLAY_STATUS=0`, `replay_01_blocker_class=build_timeout`, `replay_01_blocker_file=src/rrr/base/misc.cpp`, `replay_01_status=124`, `replay_01_timed_out=true`, `replay_01_first_failure_class=build_timeout`

Full-suite sweep (step 4):
- Workspace capture:
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_workspace_20260316_v1 --name workspace_all_targets --inactivity-timeout-seconds 90 --wall-timeout-seconds 1200 --command cargo test --workspace --all-targets`
  - observed: `workspace_all_targets.status=124`, `timeout_reason=inactivity_timeout`
  - first failing ids in capture log: `test_e2e_simple_hash_table`, `test_e2e_object_pool`, `test_e2e_simple_graph`, `test_e2e_tokenizer`, `test_e2e_trie`, `test_variadic_template_transpile`, `test_e2e_pthread`
- Python suite:
  - `python3 -m unittest discover -s tests/python -p 'test_*.py'`
  - observed: `PY_STATUS=0`, `Ran 34 tests`, `OK`, `skipped=1`

## 2026-03-16: Strict RPC Build-Timeout Loop Iteration (Leaf 2.6.d...c.c.c.c.c.c.c.c.c.c.c.c.c.c.c.a/.b)

Context:
- Continued the strict `src/rrr/base/misc.cpp` timeout loop under `2.6.d.b.ii.c.c.v.b.iii.c.c.c.c.c.c.c.c.c.c.c.c.c.c.c`.
- Decomposed the repeat controller into bounded leaves (`.a/.b/.c`) and executed `.a` then `.b`.
...
Design change (generic hot-path):
- File: `crates/fragile-clang/src/ast_codegen.rs`
- Updated `find_next_sanitization_trigger(...)` by adding a 1024-byte pass-window fast path, iterating existing reusable 32-byte probe helper calls across offsets `0..1024` in 32-byte steps, ahead of existing 512-byte/256-byte/128-byte/64-byte/32-byte/16-byte/8-byte/4-byte/tail scans.
- Scope stayed small (`~39` LOC in this iteration), with no semantic behavior changes intended.

Focused regressions:
- Added `test_find_next_sanitization_trigger_handles_one_thousand_twenty_four_byte_window_boundaries`.
- Revalidated related behavior:
  - `cargo test -p fragile-clang test_find_next_sanitization_trigger_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_find_type_sanitization_run_end_handles_ -- --nocapture`
  - `cargo test -p fragile-clang test_append_sanitized_type_for_fn_name_ -- --nocapture`
...
- Release build:
  - `cargo build --release -p fragile-cli --bin fragilec`
- Strict build-only harness:
  - `FRAGILEC_MODE=strict python3 scripts/mako_rpcbench_harness.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --build-only --jobs 4 --build-timeout-seconds 600`
  - observed: `HARNESS_STATUS=1`, `lane_fragilec_configure_status=0`, `lane_fragilec_clean_status=0`, `lane_fragilec_build_status=124`, `lane_fragilec_test_rpc_status=-1`, `lane_fragilec_failure_class=build_timeout`
- Non-increase inventory gate vs prior baseline:
  - `python3 scripts/mako_rpc_compile_blocker_inventory.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --baseline-manifest /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1/rpc_compile_blocker_inventory_manifest.txt --enforce-nonincreasing`
  - observed: `INVENTORY_STATUS=0`, `lane_fragilec_first_failing_compile_class=build_timeout`, `lane_fragilec_first_failing_compile_file=src/rrr/base/misc.cpp`, `lane_fragilec_class_rank_delta_vs_baseline=0`, `lane_fragilec_e0425_delta_vs_baseline=0`, `lane_fragilec_nonincrease_gate_pass=true`, `nonincrease_gate_pass=true`
- Blocker replay:
  - `python3 scripts/mako_rpc_compile_blocker_replay.py --run-root /tmp/fragile_rpc_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_build_only_20260316_v1 --lanes fragilec --max-replays 1 --timeout-seconds 300`
  - observed: `REPLAY_STATUS=0`, `replay_01_blocker_class=build_timeout`, `replay_01_blocker_file=src/rrr/base/misc.cpp`, `replay_01_status=124`, `replay_01_timed_out=true`, `replay_01_first_failure_class=build_timeout`

Full-suite sweep (step 4):
- Workspace capture:
  - `python3 scripts/ci_command_capture.py --run-root /tmp/fragile_leaf_2_6d_b_ii_c_c_v_b_iii_c_c_c_c_c_c_c_c_c_c_c_c_c_c_c_b_workspace_20260316_v1 --name workspace_all_targets --inactivity-timeout-seconds 90 --wall-timeout-seconds 1200 --command cargo test --workspace --all-targets`
  - observed: `workspace_all_targets.status=124`, `timeout_reason=inactivity_timeout`
  - first failing ids in capture log: `test_e2e_simple_hash_table`, `test_e2e_object_pool`, `test_e2e_simple_graph`, `test_e2e_tokenizer`, `test_e2e_trie`, `test_variadic_template_transpile`, `test_e2e_pthread`
- Python suite:
  - `python3 -m unittest discover -s tests/python -p 'test_*.py'`
